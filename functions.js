...
function askQuestion(firstName){
console.log(`Hi there ${firstName}, how is it going today?`);
}
...
function setRange(companyName, num1, num2){
var payRange = num1 - num2;
console.log(`The pay range for this job at ${companyName} is ${payRange}.`);
}
setRange("Google",110000,90000);
